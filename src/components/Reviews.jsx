...
const Reviews = () => {
    ...
    useEffect(() => {
        const unsub = onSnapshot(query(collection(database, 'reviews')), snap => {
    ...
    return (
        <div className='max-w-[100%] my-auto my-16 p-4'>
            <div className="flex flex-col px-20">
                <h1 className='text-3xl font-bold text-center underline my-20'>All users reviews</h1>
                <div className="flex flex-row justify-end">
                    <button className='border px-6 py6 py-2 my-4 bg-blue-600 rounded-md text-white'>{data.length} reeviews in total</button>
                </div>
                <input value={search} onChange={(e) => filterUsers(e.target.value)} className='border p-3' placeholder='Search by shop/vendor name' type='text' />
                                        ...
                                        filtered.map(data => {
                                            return (
                                                <tr key={data.id}>
                                                    ...
                                                    <td data="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap">
                                                        {data.sname}
                                                    </td>
